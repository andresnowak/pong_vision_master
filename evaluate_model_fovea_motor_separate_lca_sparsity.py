...
from src.dqn_efficient import QNetwork
...
def evaluate_agent(env, vector_env, model_path: str, config):
    ...
    plot_results_for_paper(dense_result, sparse_results, "outputs_figures/fovea_motor_separate_lca")
    save_results(
        dense_result, sparse_results, "outputs_figures/fovea_motor_separate_lca"
    )
